...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'loffel:migrate:subscriptions {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Migrate Loffel Subscriptions Tables.';
