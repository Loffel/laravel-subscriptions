...
namespace Loffel\Subscriptions\Traits;
...
trait HasPlanSubscriptions
{
    ...
    {
        return $this->morphMany(config('loffel.subscriptions.models.plan_subscription'), 'subscriber', 'subscriber_type', 'subscriber_id');
    }
     ...
     *
     * @return \Loffel\Subscriptions\Models\PlanSubscription|null
     */
    ...
    public function subscribedPlans(): Collection
    {
        ...
        return app('loffel.subscriptions.plan')->whereIn('id', $planIds)->get();
    }
     ...
     *
     * @return \Loffel\Subscriptions\Models\PlanSubscription
     */
